...
function YoutubeWidget() {
  ...
  const handlePlay = (id: string) => {
    setYoutubeEmbedSrc(`https://www.youtube.com/embed/${id}?autoplay=1`);
  };
        ...
        <div style={{ flex: 1, borderRadius: 12, overflow: 'hidden', background: '#000', display: 'flex', flexDirection: 'column' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 12px', background: '#1e293b', color: 'white', alignItems: 'center' }}>
             <div style={{ fontSize: 12, fontWeight: 600, display: 'flex', alignItems: 'center', gap: 6 }}>
               ...
               Sedang Diputar (Musik tetap berjalan walau pindah menu)
             </div>
             <button type="button" onClick={() => setYoutubeEmbedSrc(null)} style={{ background: 'transparent', border: 'none', color: '#94a3b8', cursor: 'pointer' }}>Tutup</button>
           </div>
    ...
    <div className="page active">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '7fr 5fr', gap: '24px', marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          <div className="card" style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 400, padding: 20 }}>
